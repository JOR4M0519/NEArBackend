    ...
    <div class="info">
      ...
      <section id="informacion-personal">
        ...
        <div id="Derecho">
         ...
         <div class="conten-info">#nombre</div>

         <div class="titulos-info" >Correo</div>
         <div class="conten-info">#correo</div>
        ...
        <div id="izquierdo">
         ...
         <div class="conten-info" style="margin-bottom: 8.7%;">#apellidonombre</div>
        
         <div class="titulos-info" >Rol</div>
         <div class="conten-info">#rol</div>
