          ...
          <div class="coin">
            ...
            <div class="card-body">
              ...
              <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Cantidad de Fcoins" aria-label="Recipient's username" aria-describedby="basic-addon2" disabled>
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="Cuantos Fcoins quieres recargar?" aria-label="Username" aria-describedby="basic-addon1">
              </div>
